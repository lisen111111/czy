  ...
  <div>
      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='duzhe'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="password"#elsetype="text" />
			</el-form-item>
			<el-form-item label="确认密码" class="input" v-if="tableName=='duzhe'">
			...
			<el-form-item label="姓名" class="input" v-if="tableName=='duzhe'">
			...
			<el-form-item label="手机" class="input" v-if="tableName=='duzhe'">
			...
			<el-form-item label="身份证" class="input" v-if="tableName=='duzhe'">
			...
			<el-form-item label="邮箱" class="input" v-if="tableName=='duzhe'">
			...
			<el-form-item label="地址" class="input" v-if="tableName=='duzhe'">
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      if((!this.ruleForm.zhanghao) && `duzhe` == this.tableName){
      ...
      if(`duzhe` == this.tableName && this.ruleForm.youxiang&&(!this.$validate.isEmail(this.ruleForm.youxiang))){
 ...
 //  }
	...
	.container {
		...
		background-repeat: no-repeat;
    				background-image: url(http://codegen.caihongy.cn/20220121/d55a632e6afa415f9f34adb2cd4dd26d.png);
      ...
      box-sizing: border-box;
			...
			background-color: rgba(155, 200, 183, 0.92);
			box-shadow: 0 0 6px rgba(155, 200, 183, 1);
