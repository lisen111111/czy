<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="借阅编号" prop="jieyuebianhao">
            <el-input v-model="ruleForm.jieyuebianhao" 
                placeholder="借阅编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jieyuebianhao" label="借阅编号" prop="jieyuebianhao">
              <el-input v-model="ruleForm.jieyuebianhao" 
                placeholder="借阅编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.tushutupian" label="图书图片" prop="tushutupian">
          <file-upload
          tip="点击上传图书图片"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.tushutupian?ruleForm.tushutupian:''"
          @change="tushutupianUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.tushutupian" label="图书图片" prop="tushutupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.tushutupian.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="借书日期" prop="jieshuriqi">
          <el-input v-model="ruleForm.jieshuriqi" 
              placeholder="借书日期" clearable  :readonly="ro.jieshuriqi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="借书日期" prop="jieshuriqi">
              <el-input v-model="ruleForm.jieshuriqi" 
                placeholder="借书日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="续借日期" prop="xujieriqi">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.xujieriqi" 
                type="datetime"
                :readonly="ro.xujieriqi"
                placeholder="续借日期">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.xujieriqi" label="续借日期" prop="xujieriqi">
              <el-input v-model="ruleForm.xujieriqi" 
                placeholder="续借日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="续借备注" prop="xujiebeizhu">
          <el-input v-model="ruleForm.xujiebeizhu" 
              placeholder="续借备注" clearable  :readonly="ro.xujiebeizhu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="续借备注" prop="xujiebeizhu">
              <el-input v-model="ruleForm.xujiebeizhu" 
                placeholder="续借备注" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  ...
  created() {
	this.ruleForm.xujieriqi = this.getCurDateTime()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tushumingcheng = true;
          ...
          if(o=='tushutupian'){
            this.ruleForm.tushutupian = obj[o];
	    this.ro.tushutupian = true;
            continue;
          }
          if(o=='jieshuriqi'){
	    ...
	    this.ro.xingming = true;
          ...
          if(o=='xujieriqi'){
            this.ruleForm.xujieriqi = obj[o];
	    this.ro.xujieriqi = true;
            continue;
          }
          if(o=='xujiebeizhu'){
            this.ruleForm.xujiebeizhu = obj[o];
	    this.ro.xujiebeizhu = true;
            continue;
          }
          if(o=='userid'){
	...
	if(this.ruleForm.tushutupian!=null) {
		this.ruleForm.tushutupian = this.ruleForm.tushutupian.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `tushuxujie/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.tushuxujieCrossAddOrUpdateFlag = false;
						 this.parent.search();
    ...
    tushutupianUploadChange(fileUrls) {
	this.ruleForm.tushutupian = fileUrls;
	this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
