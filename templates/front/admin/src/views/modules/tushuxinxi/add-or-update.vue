<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="出版日期" prop="chubanriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.chubanriqi" 
                type="date"
                :readonly="ro.chubanriqi"
                placeholder="出版日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.chubanriqi" label="出版日期" prop="chubanriqi">
              <el-input v-model="ruleForm.chubanriqi" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="图书位置" prop="tushuweizhi">
          <el-input v-model="ruleForm.tushuweizhi" 
              placeholder="图书位置" clearable  :readonly="ro.tushuweizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="图书位置" prop="tushuweizhi">
              <el-input v-model="ruleForm.tushuweizhi" 
                placeholder="图书位置" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="图书简介" prop="tushujianjie">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.tushujianjie" label="图书简介" prop="tushujianjie">
                    <span>{{ruleForm.tushujianjie}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.chubanshe = true;
          ...
          if(o=='chubanriqi'){
            this.ruleForm.chubanriqi = obj[o];
	    this.ro.chubanriqi = true;
            continue;
          }
          if(o=='shuliang'){
	    ...
	    this.ro.tushujianjie = true;
          ...
          if(o=='tushuweizhi'){
            this.ruleForm.tushuweizhi = obj[o];
	    this.ro.tushuweizhi = true;
            continue;
          }
        }
      }
