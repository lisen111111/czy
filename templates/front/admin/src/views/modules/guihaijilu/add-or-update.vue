<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="归还编号" prop="guihaibianhao">
            <el-input v-model="ruleForm.guihaibianhao" 
                placeholder="归还编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.guihaibianhao" label="归还编号" prop="guihaibianhao">
              <el-input v-model="ruleForm.guihaibianhao" 
                placeholder="归还编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="借书日期" prop="jieshuriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.jieshuriqi" 
                type="date"
                :readonly="ro.jieshuriqi"
                placeholder="借书日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jieshuriqi" label="借书日期" prop="jieshuriqi">
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="还书日期" prop="haishuriqi">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.haishuriqi" 
                type="datetime"
                :readonly="ro.haishuriqi"
                placeholder="还书日期">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.haishuriqi" label="还书日期" prop="haishuriqi">
              <el-input v-model="ruleForm.haishuriqi" 
                placeholder="还书日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  ...
  created() {
	this.ruleForm.haishuriqi = this.getCurDateTime()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='guihaibianhao'){
            this.ruleForm.guihaibianhao = obj[o];
	    this.ro.guihaibianhao = true;
            continue;
          }
          if(o=='zuozhe'){
	    ...
	    this.ro.jieshuriqi = true;
          ...
          if(o=='haishuriqi'){
            this.ruleForm.haishuriqi = obj[o];
	    this.ro.haishuriqi = true;
            continue;
          }
          if(o=='userid'){
    ...
    zhanghaoChange () {
      this.$http({
        url: `follow/duzhe/zhanghao?columnValue=`+ this.ruleForm.zhanghao,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `guihaijilu/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.guihaijiluCrossAddOrUpdateFlag = false;
						 this.parent.search();
